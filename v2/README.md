...
2. **📐 01 - IP Schemes**: Plan IP ranges and VLANs 
3. **🔒 02 - Firewall Setup**: Configure pfSense with rules and routing  
4. **🖥️ 03 - Virtual Machines**: Deploy lab VMs on Proxmox  
5. **🌐 04 - Network Segmentation**: Apply VLANs and isolation  
6. **🛡️ 05 - Security Hardening**: Apply firewall hardening and monitoring  
7. **🧪 06 - Labs / Exercises**: Deploy vulnerable apps, capture traffic, analyze  
8. **✍️ 07 - Lessons Learned**: Review and reflect  
